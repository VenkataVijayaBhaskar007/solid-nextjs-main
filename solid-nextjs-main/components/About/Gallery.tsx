...
<div className="relative">
  ...
  <img className="h-auto max-w-full rounded-lg" src="./images/gallery/610598/10.png" alt="" />
  <div className="gradient-overlay " ></div>
  <div className="image-info">
  <h3 className="text-3xl ">Atoms</h3>
    <p>Description of Atoms.</p>
...
<div className="relative">
  ...
  <img className="h-auto max-w-full rounded-lg" src="./images/gallery/610854/9.png" alt="" />
  <div className="gradient-overlay " ></div>
  <div className="image-info">
  <h3 className="text-3xl ">Atoms</h3>
    <p>Description of Atoms.</p>
